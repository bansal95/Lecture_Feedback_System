...
?>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
			...
			<li class="active"><a href="faculty_activities.php"><i class="fa fa-group" aria-hidden="true" style="font-size:16px;color:white"></i> &nbsp;&nbsp; Activities</a></li>
			 </ul>
    </div>
...
?>
                             ...
                             <div class="row"><div class="col-xs-6 col-md-6"></div><div class="col-xs- 3 col-md-3"><button type="button" class="btn btn-default btn-md pull" id="kdkd" >Click</button>
                                </div></div><br><br>
                                    <script>
                                    $(document).ready(function(){
...
<form>
    <table>
        <tr>
            <td id="response1">
                <!--Response1 will be inserted here-->
            </td>
        </tr>
    </table>
</form>
</div>
 <div class="b3 form-group"  style="display: none;">
<form>
    <table>
        <tr>
            <td id="response1">
