...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="index_db.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Dashboard</a></li>
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?php include'orders.php' ;
								echo $o; ?></div>
		...
		<div class="row">
			...
			">
				...
				<div class="panel panel-blue">
					...
					include 'connection.php';
					$u=$_SESSION['userName'];
			$sql_q="Select task from todo where uname='$u'";
