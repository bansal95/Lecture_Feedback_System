...
<body>
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="remove_userdetails.php"><i class="fa fa-user-times" aria-hidden="true" style="font-size:16px;color:white"></i> &nbsp;&nbsp; Remove User</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">REMOVE DETAILS</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-8">
				...
				right:0px;
				">
					<div class="panel-heading"> <i class="fa fa-user-plus" aria-hidden="true" style="font-size:20px;color:black; "></i> Enter Username</div>
					<div class="panel-body">
						<form class="form-horizontal" action="remove_userdetails.php" method="post">
							<fieldset>
								<!-- UserName-->
				...
				<?php
						function removeUserDetails($user) {
						    	$db = $_SESSION['db'];
								$collection = $db->User;
								$cursor = $collection->findOne(array("uname" => new MongoRegex("/$user/i")));
								if($cursor!=NULL && $cursor["who"] != 'admin'){
									$collection->remove(array("uname"=> $user));
